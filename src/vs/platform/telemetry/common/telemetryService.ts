...
Trove separately records basic usage like the number of messages people are sending. If you'd like to disable Trove metrics, you may do so in Trove's Settings.
`;
