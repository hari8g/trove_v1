...
import { TROVE_OPEN_SETTINGS_ACTION_ID } from '../../trove/browser/troveSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openVoid', comment: ['&& denotes a mnemonic'] }, "&&Open Trove Settings"),
	},
	order: 1
});
