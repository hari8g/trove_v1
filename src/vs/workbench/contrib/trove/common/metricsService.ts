...
export class MetricsService implements IMetricsService {
	...
	constructor(
		...
		this.metricsService = ProxyChannel.toService<IMetricsService>(mainProcessService.getChannel('trove-channel-metrics'));
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'troveDebugInfo',
			f1: true,
			title: localize2('troveMetricsDebug', 'Trove: Log Debug Info'),
		});
	}
