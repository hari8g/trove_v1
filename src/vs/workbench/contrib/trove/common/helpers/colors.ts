...
// gets converted to --vscode-trove-greenBG, see trove.css, asCssVariable
registerColor('trove.greenBG', configOfBG(acceptBG), '', true);
registerColor('trove.redBG', configOfBG(rejectBG), '', true);
registerColor('trove.sweepBG', configOfBG(sweepBG), '', true);
registerColor('trove.highlightBG', configOfBG(highlightBG), '', true);
registerColor('trove.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
