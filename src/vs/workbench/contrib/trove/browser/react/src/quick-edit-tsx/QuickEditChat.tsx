...
import { TextAreaFns, TroveInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, TroveChatArea } from '../sidebar-tsx/SidebarChat.js';
import { TROVE_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/trove/common/troveSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-trove-fg-3"
	/>
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(TROVE_CTRL_K_ACTION_ID)?.getLabel()
