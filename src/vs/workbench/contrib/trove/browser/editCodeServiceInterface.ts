...
import { Diff, DiffArea, VoidFileSnapshot, EditApplyResult } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	instantlyApplySearchReplaceBlocks(opts: { uri: URI; searchReplaceBlocks: string }): Promise<EditApplyResult>;
	instantlyRewriteFile(opts: { uri: URI; newContent: string }): Promise<EditApplyResult>;
